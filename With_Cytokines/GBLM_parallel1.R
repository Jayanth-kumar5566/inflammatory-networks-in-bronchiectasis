#Reading the dataset
#data=read.csv("./2+/Y/Microbes.csv",row.names = 1)*100
...
data=read.csv("./N/Microbes.csv",row.names = 1)*100
out_final_1<-GBLM(data)
write.csv(out_final_1,"./N/adj_to_cyto.csv")

data=read.csv("./Y/Microbes.csv",row.names = 1)*100
out_final_3<-GBLM(data)
write.csv(out_final_3,"./Y/adj_to_cyto.csv")
